...
public class User extends DomainNode {
     ...
     */
    private void setEncryptedPassword(String encrypted_password) {
     ...
     */
    private void setAccountNumber(int account_number) {
     ...
     */
    private void setRoutingNumber(int routing_number) {
     ...
     */
    private void setAccountBalance(int account_balance) {
